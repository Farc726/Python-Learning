...
# 2. 找出同时选修了所有四门课程的学生
print(f"同时选修了所有四门课程的学生:{football_set&basketball_set&fa_set}")

# 3. 找出选修了足球，但是没有选修篮球的学生
#1.
print(f"选修了足球，但是没有选修篮球的学生:{football_set.difference(basketball_set)}")
#2.-运算符
print(f"选修了足球，但是没有选修篮球的学生:{football_set-basketball_set}")
#3. 集合推导式----->快速构建集合，语法{向集合中添加的元素 for s in set if 条件}
...
for name in all_set:
    print(f"{name}选修了{all_list.count(name)}门课程")
